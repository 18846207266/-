...
int main() {
    ...
    Print_Data(s1);
    // 1.1_if (Delete_Slist(&s1, 3) == OK) {
    //     printf("成功删除元素3\n");
    //     Print_Data(s1);
    // } else {
    //     printf("未找到相应元素");
    // }
    // 1.2_if (Delete_Slist_index(&s1, 3) == OK) {
    //     printf("成功删除3号元素\n");
    //     Print_Data(s1);
    // } else {
    //     printf("未找到相应元素");
    // }
    // 2_if (Delete_Slist_repeat(&s1) == OK) Print_Data(s1);
    // 3_Inversion_Slist(&s1);
    // 4_R_L_Move_Slist(&s1, -2);
